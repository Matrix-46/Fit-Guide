...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchDashboardData() {
        ...
        // Show the skeleton immediately to avoid blank screen
        ...
        try {
            ...
            if (window.location.hash === '#dashboard/logs') fetchAndDisplayWorkoutLogs_v2();
            ...
            if (String(error.message).toLowerCase().includes("unauthorized") || String(error.message).includes("401")) {
                ...
                currentUserData = null; localStorage.removeItem('Fit-GuideUser'); navigateTo('login');
            }
            else {
                showUserMessage(dashboardApiMessage || loginMessage, `Error loading dashboard: ${error.message}`, true, false);
            }
        }
    }
